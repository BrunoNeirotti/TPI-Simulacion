...
establecida por ley, se encuentra en proceso licitatorio y su Estudio de Impacto Ambiental fue convocado a
audiencia pública para el 18 de agosto de 2026.
...
Los pedidos de acceso a la información pública cursados para obtener ese material continúan en trámite, y el
trabajo está diseñado para no quedar condicionado a su resultado: los parámetros que la documentación
disponible no permita fijar se declaran como supuestos y se someten a análisis de sensibilidad.
...
e internacional y con audiencia pública ambiental convocada. Se trata de un corredor
...
de Impacto Ambiental refiere 10,9 km de túneles [13]; se adopta la primera cifra para dimensionar el
servicio y se deja constancia de la segunda. El objetivo de descongestionar las líneas existentes y de mejorar la
...
A lo anterior se suma un dato del propio expediente que permite dimensionar el
...
diarios; se trata, no obstante, de una cifra anunciada y no del resultado de un estudio publicado, y como
tal se la utiliza. El
...
discontinuidad que condiciona la elección de períodos: la apertura a medios de pago distintos de SUBE (pago
sin contacto desde diciembre de 2024 y código QR desde mayo de 2025) amplió la cobertura del registro, cambio que los archivos
...
par de andenes conectados. Esto reemplaza la estimación propia de esos parámetros, con una advertencia de
vigencia que obliga a un uso selectivo: el feed declara período hasta 2019 y el portal informa que los
datasets en formato GTFS están suspendidos y en revisión. La topología que describe continúa siendo la
vigente (incluye la extensión de la Línea E a Retiro y la Línea H hasta Facultad de Derecho) y los tiempos
de tramo, de detención y de combinación son magnitudes físicas estables: ambos se utilizan. Las frecuencias
programadas que el feed contiene, en cambio, son previas a la pandemia y no se emplean, porque los
intervalos de despacho se estiman del registro de operación real [4]. La
...
tiempo de transbordo de las estaciones nuevas. Los tiempos de recorrido entre estaciones se derivan de las
progresivas publicadas y de esos mismos parámetros cinemáticos. La frecuencia de
...
contra ese perfil, y el contraste se declara como referencia y no como validación: ese perfil no es una
medición sino la salida de otro modelo, es anterior a la pandemia y a la apertura de medios de pago, y
lleva incorporado un supuesto de simetría diaria (las tablas de la hora pico de la mañana y de la tarde son
la imagen especular exacta una de la otra) de la misma naturaleza que el que hereda la matriz
origen--destino. Se agrega un control de consistencia entre fuentes oficiales: los ascensos que ese
...
estudios oficiales del proyecto: los valores absolutos que arroje el modelo dependen de supuestos
declarados de manera explícita. Lo informativo es la comparación entre escenarios evaluados bajo esos
...
\item[] [13] Agencia de Protección Ambiental, Gobierno de la Ciudad Autónoma de Buenos Aires.
  ...
  195/GCABA-APRA/26, fijada para el 18 de agosto de 2026. Se citan en particular: IF-2026-20219129-GCABA-APRA,
